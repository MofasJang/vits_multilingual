...
def get_text(text, hps):
    ...
    return text_norm
def synthesize(texts,config_path,checkpoint_path):
...
if __name__=="__main__":
    texts=["英伟达开源的自然语音处理开发套件from the standpoint of the good of the industries themselves, as well as the general public interest",
